...
{
    public partial class U_CategoriesBooks : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            id = Request.QueryString["kategori"];
            if (Page.IsPostBack == false)
            {
                SqlCommand cd1 = new SqlCommand("select *from Tbl_Kategoriler where KategoriId=@p1", conn.connection());
                cd1.Parameters.AddWithValue("@p1", id);
                ...
                SqlCommand cd2 = new SqlCommand("select *from Tbl_Kitaplar where KategoriId=@p1", conn.connection());
                cd2.Parameters.AddWithValue("@p1", id);
