...
{
    public partial class U_NewReleases : System.Web.UI.Page
    {
        string addBasket = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cd = new SqlCommand("select top 21 *from Tbl_Kitaplar order by KitapBaskiTarih desc", conn.connection());
