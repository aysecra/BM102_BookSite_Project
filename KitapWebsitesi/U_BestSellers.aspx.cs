...
{
    public partial class U_BestSellers : System.Web.UI.Page
    {
        string addBasket = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cd = new SqlCommand("select top 21 *from Tbl_Kitaplar order by KitapSatisMiktar desc", conn.connection());
